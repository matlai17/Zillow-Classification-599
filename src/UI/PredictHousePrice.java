...
public class PredictHousePrice {
	...
	public static void main(String[] args) {
            ...
            //Change how the UI looks like. You can use different UI types if you think something else might look better.
            try { UIManager.setLookAndFeel(UIManager.getSystemLookAndFeelClassName()); } 
            catch (ClassNotFoundException | InstantiationException | IllegalAccessException | UnsupportedLookAndFeelException ex) 
            { Logger.getLogger(PredictHousePrice.class.getName()).log(Level.SEVERE, null, ex); }
	...
	public void showtable(ArrayList<String[]> data, String city) {
		...
		for (int i = 0; i < filteredData.size(); i++)
			if (filteredData.get(i)[1].equals(city) || city.equals("All Cities")) {
		...
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
                ...
                KeyListener kL = new java.awt.event.KeyAdapter() {
                    ...
                    public void keyReleased(KeyEvent e) {
                        ...
                        if(key == KeyEvent.VK_ESCAPE) frame.dispose();
                    }
                };
